...
\Begin{
    {\begingroup\scriptsize\justifying\setlength{\emergencystretch}{3em}
...
\Begin{
    {\begingroup\scriptsize\justifying\setlength{\emergencystretch}{3em}
        ...
        Extract features from structured and unstructured text using NLP\;
        \Indm
        ...
        \Indp
        Train NCF to predict personalized recommendations\;
        \Indm
        \textbf{Sub-step 3.2: Graph Modeling}\;
        \Indp
        Construct Knowledge Graph of skills, learning paths, objectives\;
        Train GNN to capture relational dependencies\;
        \Indm
        \textbf{Sub-step 3.3: Textual Understanding}\;
        \Indp
        Train Transformer model on employee goal statements\;
        ...
        Aggregate predictions from NCF, GNN, and Transformer\;
        ...
        Update training datasets and retrain models periodically\;
        \Indm
    \endgroup}
}
\end{algorithm}
